...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='user',
            name='avatar',
            field=models.CharField(blank=True, default='avatars/defaults/avatar1.jpg', help_text='Путь к аватарке пользователя (загруженной или дефолтной).', max_length=100, null=True),
        ),
        migrations.CreateModel(
            name='SubjectLabWork',
            fields=[
